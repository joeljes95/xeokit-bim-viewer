...
class PropertiesInspector extends Controller {
    ...
    clear() {
        const html = [],
            localizedText = this.viewer.localeService.translate('test') || 'No object inspected 2. Right-click or long-tab an object and select \'Inspect Properties\' to view its properties here.';
